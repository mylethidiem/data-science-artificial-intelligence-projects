...
1. **Build Baseline MLP** – Implement a simple MLP as the starting point.
1. **Training** – Train the baseline model and observe vanishing gradient issues.
1. **Evaluation** – Compare baseline and improved models using metrics and loss curves.
